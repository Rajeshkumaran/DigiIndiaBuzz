...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation2=AnimationUtils.loadAnimation(getApplicationContext(),R.anim.fadeout);
        slideshow=(ImageView)findViewById(R.id.slideshow);

        /*slideshow.setImageResource(R.drawable.pic1);
        set=(AnimatorSet) AnimatorInflater.loadAnimator(this,R.animator.wave);
        set.setTarget(slideshow);
        set.start();*/
        ...
        h.postDelayed(new Runnable() {
            ...
            public void run() {
                    if(i[0] ==3)
                    i[0] = 0;
                        slideshow.startAnimation(animation1);
        ...
        int id = item.getItemId();
         ...
         if (id == R.id.aboutus) {
            ...
            startActivity(i);
             ...
             Intent i=new Intent(MainActivity.this,Career.class);
             startActivity(i);
             this.finish();
